...
class Lstm_cl(nn.Module):
    def __init__(self, nb_features=1, hidden_size=100, nb_layers=5, dropout=0.25,bs = 60 ,act = 'relu' ,nb =8):
        ...
        self.rel = nn.ReLU()
        self.sig = nn.Sigmoid()
        self.lin1 = nn.Linear(self.hidden_size,nb)
        self.lin2 = nn.Linear(nb,2)
        self.act = act
